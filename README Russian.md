...
Знак `$` префиксно дополняет название секции, позволяя искать по файлу такой паттерн `$[НАЗВАНИЕ-СЕКЦИИ]` и тем самым **поиск ограничивается только по названиям секций**.
...
Для дальнейшего чтения рекомендую [SMACSS](http://smacss.com) от Джонатана Снука — по этой теме. я не знаю книги лучше чем эта.
