...
Я использую комментарии в стиле docBlock, которые я ограничиваю в 80 символов:
     ...
     *
     * Более длинное описание комментария, описывающего код более
     * подробно. Такие комментарии ограничиваются длиной в 80 символов.
     * 
     * Можно вставлять разметку в комментарии, мы даже рекомендуем делать это:
     * 
       <div class=foo>
           <p>Lorem</p>
       </div>
...
Если вам очень хочется написать этот кусок испольуя Sass, следует писать его так:
